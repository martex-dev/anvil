...
export function StatusBar(): JSX.Element {
	return (
		<footer
			data-part='statusbar'
			className='relative z-10 flex h-[26px] shrink-0 items-stretch gap-0.5 border-t border-glass-edge bg-glass-strong px-1.5 text-11 text-fg-2 backdrop-blur-xl'
		>
			<GitItem />
			<ProblemsItem />
			<PythonEnvChip />
