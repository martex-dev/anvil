...
export function Welcome(): JSX.Element {
	...
	return (
		// A container, not the window: the Welcome tab can sit in a narrow split editor group.
		<div className='@container'>
			<div className='mx-auto flex max-w-5xl flex-col gap-10 px-5 py-12 @xl:px-10'>
				<header className='flex items-center gap-6'>
					...
					<div>
						...
						<p className='hud mt-1'>
							python · typescript · polars · torch · ccxt · duckdb
						</p>
					</div>
				</header>
				...
				{missingKey && (
					...
					>
						...
						<span className='flex-1'>
							Add your {PROVIDER_LABEL[missingKey]} API key to turn on chat, inline
				...
				<div className='grid grid-cols-1 gap-10 @4xl:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]'>
					...
					<section className='grid grid-cols-1 content-start gap-3 @lg:grid-cols-2'>
						<Feature
